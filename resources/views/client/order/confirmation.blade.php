            ...
            <div class="luxury-card" style="background: linear-gradient(135deg, #121212 0%, #1a1a1a 100%); border: 1px solid rgba(212,175,55,0.3); border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
                ...
                <div class="card-body p-4">
                    <div class="text-center mb-5">
                        <i class="fas fa-check-circle fa-5x text-gold mb-4" style="text-shadow: 0 0 20px rgba(212,175,55,0.5);"></i>
                        <h3 class="text-gold" style="font-family: 'Playfair Display', serif;">Cảm ơn bạn đã đặt hàng!</h3>
                        <p class="text-gold-soft">Mã đơn hàng của bạn: <strong class="text-gold">{{ $order->order_code }}</strong></p>
                    </div>
                    ...
                    <div class="shipping-info mb-5">
                        <h5 class="text-gold mb-4" style="position: relative; font-family: 'Playfair Display', serif;">
                            <span class="bg-dark px-2" style="z-index: 1; position: relative;">Thông tin giao hàng</span>
                            <span class="gold-line" style="position: absolute; bottom: 8px; left: 0; width: 100%; height: 1px; background: linear-gradient(90deg, rgba(212,175,55,0.3) 0%, rgba(212,175,55,1) 50%, rgba(212,175,55,0.3) 100%); z-index: 0;"></span>
                        </h5>
                        <div class="info-grid">
                            <div class="info-item">
                            ...
                            <div class="info-item">
                                ...
                                <span class="text-gold">{{ $order->payment_method == 'cash' ? 'Thanh toán khi nhận hàng (COD)' : 'Chuyển khoản ngân hàng' }}</span>
                            </div>
                            <div class="info-item">
