...
@section('content')
    ...
    <div class="container-fluid py-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 bg-transparent">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.news-categories.index') }}" class="text-gold-soft">Danh
                        mục tin tức</a></li>
        ...
        <h1 class="h2 mt-4 mb-4 text-gold" style="font-family: 'Playfair Display', serif;">
            <i class="fas fa-plus-circle me-2"></i> Tạo mới danh mục
        </h1>
        ...
        <div class="row">
            <div class="col-12">
                <div class="luxury-card mb-4"
                    ...
                    <div class="card-body">
                        <form id="category-form" action="{{ route('admin.news-categories.store') }}" method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label text-gold">Tên danh mục <span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control bg-dark border-gold text-light"
                                            id="name" name="name" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="slug" class="form-label text-gold">Slug <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select bg-dark border-gold text-light" id="parent_id"
                                            name="parent_id">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control bg-dark border-gold text-light"
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control bg-dark border-gold text-light" id="description" name="description" rows="3"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
    ...
    <script>
        ...
        document.getElementById('category-form').addEventListener('submit', function(e) {
            ...
            // e.preventDefault(); // Nếu có dòng này thì comment lại
        });
    </script>
@endsection
