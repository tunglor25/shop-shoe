            ...
            <div class="luxury-card mb-4" style="background: linear-gradient(135deg, #121212 0%, #1a1a1a 100%); border: 1px solid rgba(212,175,55,0.3); border-radius: 15px; box-shadow: 0 10px 30px rgba(0,0,0,0.3);">
                <div class="card-header py-3" style="border-bottom: 1px solid rgba(212,175,55,0.3);">
                    <h5 class="m-0 text-gold" style="font-family: 'Playfair Display', serif;">
                        <i class="fas fa-newspaper me-2"></i> CHỈNH SỬA TIN TỨC
                    </h5>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control bg-dark border-gold text-light" id="title" name="title" value="{{ $news->title }}" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-dark border-gold text-light" id="slug" name="slug" value="{{ $news->slug }}" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if($news->image)
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/'.$news->image) }}" width="100" class="img-thumbnail">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="status" name="status" value="1" {{ $news->status ? 'checked' : '' }}>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control bg-dark border-gold text-light" id="summary" name="summary" rows="3">{{ $news->summary }}</textarea>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="mb-3">
                                    <label for="content" class="form-label text-gold">Nội dung <span class="text-danger">*</span></label>
                                    <textarea class="form-control bg-dark border-gold text-light" id="content" name="content" rows="10" required>{{ $news->content }}</textarea>
                                </div>
                            </div>
                        </div>
