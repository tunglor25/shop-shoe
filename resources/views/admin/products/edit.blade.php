                ...
                <div class="card-body p-4">
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <textarea class="form-control bg-dark border-gold text-light" name="description" id="description" rows="5">{{ old('description', $product->description) }}</textarea>
                                @error('description')
                                    <div class="text-gold-soft mt-2"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 row">
                            ...
                            <div class="col-md-8 col-lg-9">
                                ...
                                <div class="mt-3">
                                    <img src="{{ asset('storage/' . $product->image) }}" width="150" class="rounded border border-gold" style="object-fit: cover;">
                                </div>
                                @error('image')
                                    <div class="text-gold-soft mt-2"><i class="fas fa-exclamation-circle me-2"></i>{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-8 col-lg-9 d-flex align-items-center">
                                <div class="form-check me-4">
                                    <input class="form-check-input bg-dark border-gold" type="radio" value="1" name="status"
                                        id="status_active" {{ $product->status == 1 ? 'checked' : '' }} />
                                ...
                                <div class="form-check">
                                    <input class="form-check-input bg-dark border-gold" type="radio" value="0" name="status"
                                        id="status_inactive" {{ $product->status == 0 ? 'checked' : '' }} />
