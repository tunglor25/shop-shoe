                        ...
                        <table class="table mb-0" style="background: linear-gradient(135deg, #0a0a0a 0%, #121212 100%); border: 1px solid rgba(212,175,55,0.3);">
                            <thead>
                                <tr style="background: rgba(212,175,55,0.1);">
                                    ...
                                    <th class="text-gold border-gold">TÊN SẢN PHẨM</th>
                                    ...
                                    <th class="text-gold border-gold">NGÀY CẬP NHẬT</th>
                            ...
                            <tbody>
                                ...
                                <tr style="border-bottom: 1px solid rgba(212,175,55,0.1);">
                                    <td class="text-light border-gold">{{ $product->id }}</td>
                                    <td class="text-light border-gold">{{ $product->name }}</td>
                                    <td class="text-light border-gold">{{ $product->category->name }}</td>
                                    <td class="border-gold">
                                        <img src="{{ asset('storage/' . $product->image) }}" width="60"
                                             class="rounded border border-gold" style="object-fit: cover; height: 60px;">
                                    </td>
                                    <td class="text-gold border-gold">{{ number_format($product->price) }}đ</td>
                                    <td class="text-light border-gold">{{ $product->stock }}</td>
                                    <td class="border-gold">
                                        @if ($product->status == 1)
                                    ...
                                    <td class="text-light border-gold">{{ $product->created_at->format('d/m/Y') }}</td>
                                    <td class="text-light border-gold">{{ $product->updated_at->format('d/m/Y') }}</td>
                                    <td class="border-gold">
